...
From your local Windows machine, run the deployment script:

```powershell
cd F:\GitHub\vangZ_strict_patched_plus_voice_assistant
.\tools\deploy_allaw_urist.ps1
```

### What the deployment script does:

1. **Verifies SSH connection** to VPS
2. **Creates deployment package** from dev root (excludes node_modules, dev files)
